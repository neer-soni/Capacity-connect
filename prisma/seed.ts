...
async function main() {
  ...
  // ─── Resources ───
  const resourceData = [
    { courseId: course1.id, type: "video", title: "Introduction & Course Overview", duration: "12 min", uploadedBy: trainer1.id },
    { courseId: course1.id, type: "pdf", title: "Ocean Layers & Zones Handbook", size: "2.4 MB", uploadedBy: trainer1.id },
    { courseId: course1.id, type: "video", title: "Ocean Circulation Patterns", duration: "28 min", uploadedBy: trainer1.id },
    { courseId: course1.id, type: "slide", title: "Marine Ecosystems Lecture Slides", size: "5.1 MB", uploadedBy: trainer1.id },
    { courseId: course1.id, type: "video", title: "Lab: Salinity Measurement", duration: "22 min", uploadedBy: trainer1.id },
    { courseId: course2.id, type: "video", title: "Climate System Overview", duration: "18 min", uploadedBy: trainer2.id },
    { courseId: course2.id, type: "pdf", title: "IPCC AR6 Summary Guide", size: "8.7 MB", uploadedBy: trainer2.id },
    { courseId: course2.id, type: "video", title: "Greenhouse Effect Deep Dive", duration: "34 min", uploadedBy: trainer2.id },
    { courseId: course3.id, type: "video", title: "Atmospheric Structure", duration: "15 min", uploadedBy: trainer3.id },
    { courseId: course3.id, type: "pdf", title: "Indian Monsoon Study Guide", size: "4.2 MB", uploadedBy: trainer3.id },
  ];
